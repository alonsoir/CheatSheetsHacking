...
def summarize_video(url):
    try:
        ...
        # Obtén la transcripción del video usando youtube-transcript-api
        transcript = YouTubeTranscriptApi.get_transcript(video_id, languages=['en'])

        # Combina los textos de la transcripción
...
def send_whatsapp_message(url, message):
    ...
    url = f"https://api.callmebot.com/whatsapp.php?phone={phone_number}&text={text_message}&apikey={api_key}"
